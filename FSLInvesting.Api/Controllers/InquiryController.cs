...
public class InquiryController : ControllerBase
{
    ...
    [ServiceFilter(typeof(ApiKeyFilter))]
    [HttpPost("Inquiry")]
    public async Task<IActionResult> Create(InquiryModel inquiry, [FromHeader(Name = "x-api-key")] [Required] string header)
    {
    ...
    [ServiceFilter(typeof(ApiKeyFilter))]
    [HttpPut("Inquiry/{id}")]
    public async Task<IActionResult> Update(string id, InquiryModel inquiry, [FromHeader(Name = "x-api-key")] [Required] string header)
    {
