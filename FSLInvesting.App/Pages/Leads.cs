...
public partial class Leads
{
    ...
    private bool FilterFunc(Inquiry inquiry)
    {
        return FilterFunc(inquiry, SearchString);
    }

    private bool FilterFunc(Inquiry inquiry, string searchString)
    {
    ...
    private async Task ShowDeleteInquiryDialog(string id)
    {
        ...
        if (!result!.Canceled) Inquiries = await InquiryService.Get();
    }
